// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_CameraIO\CameraIO_ip_rdfifo_last.v
// 
...
// -------------------------------------------------------------
// 
// Module: CameraIO_ip_rdfifo_last
// Source Path: CameraIO_ip/CameraIO_ip_axi4/CameraIO_ip_axi4_module/CameraIO_ip_rdfifo_last
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module CameraIO_ip_rdfifo_last
  ...
  CameraIO_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                            .DataWidth(1)
                                            )
                                          u_CameraIO_ip_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),  // ufix1
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // CameraIO_ip_rdfifo_last
