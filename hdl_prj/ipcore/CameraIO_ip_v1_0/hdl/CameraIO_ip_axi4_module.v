// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_CameraIO\CameraIO_ip_axi4_module.v
// 
...
// -------------------------------------------------------------
// 
// Module: CameraIO_ip_axi4_module
// Source Path: CameraIO_ip/CameraIO_ip_axi4/CameraIO_ip_axi4_module
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module CameraIO_ip_axi4_module
  ...
  CameraIO_ip_rdfifo_data u_CameraIO_ip_rdfifo_data_inst (.clk(clk),
                                                          .reset_x(reset_x),
                                                          .enb(const_1),
                                                          .In(data_read),  // ufix32
  ...
  CameraIO_ip_rdfifo_rid u_CameraIO_ip_rdfifo_rid_inst (.clk(clk),
                                                        .reset_x(reset_x),
                                                        .enb(const_1),
                                                        .In(rid_int),  // ufix16
                                                        .Push(ar_transfer),  // ufix1
  ...
  CameraIO_ip_rdfifo_last u_CameraIO_ip_rdfifo_last_inst (.clk(clk),
                                                          .reset_x(reset_x),
                                                          .enb(const_1),
                                                          .In(rlast_int),  // ufix1
                                                          .Push(ar_transfer),  // ufix1
  ...
  assign reset_internal = reset_x | soft_reset;
...
endmodule  // CameraIO_ip_axi4_module
