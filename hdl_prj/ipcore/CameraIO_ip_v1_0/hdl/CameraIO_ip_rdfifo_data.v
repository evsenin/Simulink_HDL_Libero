// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_CameraIO\CameraIO_ip_rdfifo_data.v
// 
...
// -------------------------------------------------------------
// 
// Module: CameraIO_ip_rdfifo_data
// Source Path: CameraIO_ip/CameraIO_ip_axi4/CameraIO_ip_axi4_module/CameraIO_ip_rdfifo_data
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module CameraIO_ip_rdfifo_data
  ...
  CameraIO_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                          .DataWidth(32)
                                          )
                                        u_CameraIO_ip_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                       .enb(enb),
                                                                                       .wr_din(In),
                                                                                       .wr_addr(w_waddr),
                                                                                       .wr_en(w_we),  // ufix1
...
endmodule  // CameraIO_ip_rdfifo_data
