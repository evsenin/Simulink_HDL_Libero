// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_CameraIO\CameraIO_ip_rdfifo_rid.v
// 
...
// -------------------------------------------------------------
// 
// Module: CameraIO_ip_rdfifo_rid
// Source Path: CameraIO_ip/CameraIO_ip_axi4/CameraIO_ip_axi4_module/CameraIO_ip_rdfifo_rid
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module CameraIO_ip_rdfifo_rid
  ...
  CameraIO_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                        ...
                                        u_CameraIO_ip_rdfifo_rid_classic_ram (.clk(clk),
                                                                              .enb(enb),
                                                                              .wr_din(In),
                                                                              .wr_addr(w_waddr),
                                                                              .wr_en(w_we),  // ufix1
...
endmodule  // CameraIO_ip_rdfifo_rid
