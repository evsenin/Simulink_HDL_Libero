// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_axi4_module.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_axi4_module
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4/SYSTEM_ip_axi4_module
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_axi4_module
  ...
  wire in_burst_out;  // ufix1
  wire soft_reset_after_hold;  // ufix1
  reg  axi4_awvalid1;
  reg  axi4_wvalid1;
  ...
  assign reset_x =  ~ AXI4_ARESETN;



  assign enb = const_1;

  SYSTEM_ip_rdfifo_data u_SYSTEM_ip_rdfifo_data_inst (.clk(clk),
                                                      .reset_x(reset_x),
                                                      .enb(const_1),
                                                      .In(data_read),  // ufix32
  ...
  always @(AXI4_ARADDR, AXI4_ARBURST, AXI4_ARID, AXI4_ARLEN, AXI4_ARVALID, AXI4_AWADDR,
       AXI4_AWBURST, AXI4_AWID, AXI4_AWVALID, AXI4_BREADY, AXI4_WLAST,
       AXI4_WVALID, axi4_ar_transfer, axi4_awtransfer, axi4_raddr,
       ...
       axi4_wtransfer, fifo_afull_data) begin
  ...
  SYSTEM_ip_rdfifo_rid u_SYSTEM_ip_rdfifo_rid_inst (.clk(clk),
                                                    .reset_x(reset_x),
                                                    .enb(const_1),
                                                    .In(rid_int),  // ufix16
                                                    .Push(ar_transfer),  // ufix1
  ...
  SYSTEM_ip_rdfifo_last u_SYSTEM_ip_rdfifo_last_inst (.clk(clk),
                                                      .reset_x(reset_x),
                                                      .enb(const_1),
                                                      .In(rlast_int),  // ufix1
                                                      .Push(ar_transfer),  // ufix1
  ...
  assign in_burst_out = in_burst_axi4_master_rd | in_burst_axi4_master_wr;



  SYSTEM_ip_reset_hold u_SYSTEM_ip_reset_hold_inst (.clk(clk),
                                                    .reset_x(reset_x),
                                                    .reset_in(soft_reset),  // ufix1
                                                    .in_burst(in_burst_out),  // ufix1
                                                    .reset_out(soft_reset_after_hold),  // ufix1
                                                    .reset_pending(soft_reset_pending)  // ufix1
                                                    );

  assign reset_internal = reset_x | soft_reset_after_hold;
...
endmodule  // SYSTEM_ip_axi4_module
