// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_rdfifo_rid.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_rdfifo_rid
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4/SYSTEM_ip_axi4_module/SYSTEM_ip_rdfifo_rid
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_rdfifo_rid
  ...
  SYSTEM_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                      ...
                                      u_SYSTEM_ip_rdfifo_rid_classic_ram (.clk(clk),
                                                                          .enb(enb),
                                                                          .wr_din(In),
                                                                          .wr_addr(w_waddr),
                                                                          .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_rdfifo_rid
