// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_rd_len_fifo.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_rd_len_fifo
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4_master_rd/SYSTEM_ip_rd_len_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_rd_len_fifo
  ...
  wire w_mux1;  // ufix1
  reg  w_d1;  // ufix1
  wire [7:0] w_waddr_1;  // ufix8
  reg [7:0] w_d2;  // ufix8
  wire [7:0] w_out;  // ufix8
  reg [7:0] cache_data;  // ufix8
  wire [7:0] data_out_next;  // ufix8
  reg [7:0] Out_1;  // ufix8
  ...
  SYSTEM_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                        .DataWidth(8)
                                        )
                                      u_SYSTEM_ip_rd_len_fifo_classic_ram (.clk(clk),
                                                                           .enb(enb),
                                                                           .wr_din(In),
                                                                           .wr_addr(w_waddr),
                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_rd_len_fifo
