// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_rdata_fifo.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_rdata_fifo
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4_master_rd/SYSTEM_ip_rdata_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_rdata_fifo
  ...
  SYSTEM_ip_SimpleDualPortRAM_generic #(.AddrWidth(3),
                                      ...
                                      u_SYSTEM_ip_rdata_fifo_classic_ram (.clk(clk),
                                                                          .enb(enb),
                                                                          .wr_din(In),
                                                                          .wr_addr(w_waddr),
                                                                          .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_rdata_fifo
