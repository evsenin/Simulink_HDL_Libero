// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_wlast_fifo.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_wlast_fifo
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4_master_wr/SYSTEM_ip_wlast_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_wlast_fifo
  ...
  SYSTEM_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(3),
                                          .DataWidth(1)
                                          )
                                        u_SYSTEM_ip_wlast_fifo_classic_ram_singlebit (.clk(clk),
                                                                                      .enb(enb),
                                                                                      .wr_din(In),  // ufix1
                                                                                      .wr_addr(w_waddr),
                                                                                      .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_wlast_fifo
