// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_rdfifo_last.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_rdfifo_last
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4/SYSTEM_ip_axi4_module/SYSTEM_ip_rdfifo_last
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_rdfifo_last
  ...
  SYSTEM_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                          .DataWidth(1)
                                          )
                                        u_SYSTEM_ip_rdfifo_last_classic_ram (.clk(clk),
                                                                             .enb(enb),
                                                                             .wr_din(In),  // ufix1
                                                                             .wr_addr(w_waddr),
                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_rdfifo_last
