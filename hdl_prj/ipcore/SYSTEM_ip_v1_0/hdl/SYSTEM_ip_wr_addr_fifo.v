// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_wr_addr_fifo.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_wr_addr_fifo
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4_master_wr/SYSTEM_ip_wr_addr_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_wr_addr_fifo
  ...
  SYSTEM_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                      ...
                                      u_SYSTEM_ip_wr_addr_fifo_classic_ram (.clk(clk),
                                                                            .enb(enb),
                                                                            .wr_din(In),
                                                                            .wr_addr(w_waddr),
                                                                            .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_wr_addr_fifo
