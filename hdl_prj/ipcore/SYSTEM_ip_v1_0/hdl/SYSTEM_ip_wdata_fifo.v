// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\tb_SYSTEM\SYSTEM_ip_wdata_fifo.v
// 
...
// -------------------------------------------------------------
// 
// Module: SYSTEM_ip_wdata_fifo
// Source Path: SYSTEM_ip/SYSTEM_ip_axi4_master_wr/SYSTEM_ip_wdata_fifo
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SYSTEM_ip_wdata_fifo
  ...
  wire fifo_pop;  // ufix1
  reg [2:0] fifo_front_indx;  // ufix3
  reg [2:0] fifo_front_dir;  // ufix3
  reg [2:0] fifo_back_indx;  // ufix3
  reg [2:0] fifo_back_dir;  // ufix3
  reg [3:0] fifo_sample_count;  // ufix4
  wire [2:0] fifo_front_indx_next;  // ufix3
  wire [2:0] fifo_front_dir_next;  // ufix3
  wire [2:0] fifo_back_indx_next;  // ufix3
  wire [2:0] fifo_back_dir_next;  // ufix3
  wire [3:0] fifo_sample_count_next;  // ufix4
  wire fifo_out3;
  wire fifo_out4;
  wire fifo_write_enable;
  wire fifo_read_enable;
  wire [2:0] fifo_front_indx_temp;  // ufix3
  wire [2:0] fifo_back_indx_temp;  // ufix3
  wire [2:0] w_waddr;  // ufix3
  wire w_we;  // ufix1
  wire [2:0] w_raddr;  // ufix3
  wire Empty_1;  // ufix1
  wire [3:0] Num;  // ufix4
  wire Q_next_1;  // ufix1
  ...
  always @(posedge clk or posedge reset_x)
    begin : fifo_process
      if (reset_x == 1'b1) begin
        fifo_front_indx <= 3'b000;
        fifo_front_dir <= 3'b001;
        fifo_back_indx <= 3'b000;
        fifo_back_dir <= 3'b001;
        fifo_sample_count <= 4'b0000;
      end
      else begin
        if (enb) begin
  ...
  assign fifo_out4 = fifo_sample_count == 4'b1000;
  assign fifo_out3 = fifo_sample_count == 4'b0000;
  ...
  assign fifo_front_indx_temp = (fifo_read_enable ? fifo_front_indx + fifo_front_dir :
              fifo_front_indx);
  assign fifo_front_dir_next = (fifo_front_indx_temp == 3'b111 ? 3'b001 :
              3'b001);
  assign fifo_back_indx_temp = (fifo_write_enable ? fifo_back_indx + fifo_back_dir :
              fifo_back_indx);
  assign fifo_back_dir_next = (fifo_back_indx_temp == 3'b111 ? 3'b001 :
              3'b001);
  assign fifo_sample_count_next = (fifo_write_enable && ( ! fifo_read_enable) ? fifo_sample_count + 4'b0001 :
              (( ! fifo_write_enable) && fifo_read_enable ? fifo_sample_count + 4'b1111 :
              fifo_sample_count));
  ...
  SYSTEM_ip_SimpleDualPortRAM_generic #(.AddrWidth(3),
                                        .DataWidth(32)
                                        )
                                      u_SYSTEM_ip_wdata_fifo_classic_ram (.clk(clk),
                                                                          .enb(enb),
                                                                          .wr_din(In),
                                                                          .wr_addr(w_waddr),
                                                                          .wr_en(w_we),  // ufix1
...
endmodule  // SYSTEM_ip_wdata_fifo
